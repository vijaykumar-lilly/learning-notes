    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="mb-4">
              <Logo size="lg" showText={true} className="brightness-0 invert" />
            </div>
            <p className="text-sm text-gray-400 mb-4">
              AI-powered educational platform for multi-language learning. Master any subject at your own pace.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/curriculum" className="text-sm hover:text-white transition-colors">Curriculum</Link></li>
              <li><Link href="/subjects" className="text-sm hover:text-white transition-colors">Subjects</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/gdpr" className="text-sm hover:text-white transition-colors">GDPR</Link></li>
            </ul>
          </div>
        </div>
